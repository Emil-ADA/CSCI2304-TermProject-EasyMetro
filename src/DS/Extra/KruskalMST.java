 ...
 * type. The constructor takes &Theta;(<em>E</em> log <em>E</em>) time in the
 * worst case. Each instance method takes &Theta;(1) time. It uses
 * &Theta;(<em>E</em>) extra space (not including the graph).
 * <p>
