 ...
 * <p>
 * This implementation uses a <em>binary heap</em>. The <em>insert</em> and
 * <em>delete-the-minimum</em> operations take &Theta;(log <em>n</em>) amortized
 * time, where <em>n</em> is the number of elements in the priority queue. This
 * is an amortized bound (and not a worst-case bound) because of array resizing
 * operations. The <em>min</em>, <em>size</em>, and <em>is-empty</em> operations
 * take &Theta;(1) time in the worst case. Construction takes time proportional
 * to the specified capacity or the number of items used to initialize the data
 * structure.
 * <p>
