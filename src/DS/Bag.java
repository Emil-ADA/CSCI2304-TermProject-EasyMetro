...
/**
 * The {@code Bag} class represents a bag (or multiset) of generic items. It
 ...
 * non-static nested class. See {@link ResizingArrayBag} for a version that uses
 * a resizing array. The <em>add</em>, <em>isEmpty</em>, and <em>size</em>
 * operations take constant time. Iteration takes time proportional to the
 * number of items.
 * <p>
