...
/**
 * The {@code StdRandom} class provides static methods for generating random
 * number from various discrete and continuous distributions, including uniform,
 * Bernoulli, geometric, Gaussian, exponential, Pareto, Poisson, and Cauchy. It
 * also provides method for shuffling an array or subarray and generating random
 * permutations.
 * <p>
 * By convention, all intervals are half open. For example,
 * <code>uniform(-1.0, 1.0)</code> returns a random number between
 * <code>-1.0</code> (inclusive) and <code>1.0</code> (exclusive). Similarly,
 * <code>shuffle(a, lo, hi)</code> shuffles the <code>hi - lo</code> elements in
 * the array <code>a[]</code>, starting at index <code>lo</code> (inclusive) and
 * ending at index <code>hi</code> (exclusive).
 * <p>
...
public final class StdRandom {
     ...
     * @throws IllegalArgumentException
     *                                      unless {@code lambda > 0.0} and not
     *                                      infinite
     */
     ...
     *
     * @param probabilities
     *                          the probability of occurrence of each integer
     * @return a random integer from a discrete distribution: {@code i} with
     *         probability {@code probabilities[i]}
     * @throws IllegalArgumentException
     *                                      if {@code probabilities} is {@code null}
     * @throws IllegalArgumentException
     *                                      if sum of array entries is not (very
     *                                      nearly) equal to {@code 1.0}
     * @throws IllegalArgumentException
     *                                      unless {@code probabilities[i] >= 0.0}
     ...
     * @throws IllegalArgumentException
     *                                      if {@code frequencies} is {@code null}
     * @throws IllegalArgumentException
     *                                      if all array entries are {@code 0}
     * @throws IllegalArgumentException
     *                                      if {@code frequencies[i]} is negative
     *                                      for any index {@code i}
     * @throws IllegalArgumentException
     *                                      if sum of frequencies exceeds
     ...
     *               the array to shuffle
     * @param lo
     *               the left endpoint (inclusive)
     * @param hi
     *               the right endpoint (exclusive)
     * @throws IllegalArgumentException
     *                                      if {@code a} is {@code null}
     * @throws IllegalArgumentException
     *                                      unless
